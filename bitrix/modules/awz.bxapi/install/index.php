...
class awz_bxapi extends CModule
{
	var $MODULE_ID = "awz.bxapi";
    var $MODULE_VERSION;
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage("AWZ_BXAPI_MODULE_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("AWZ_BXAPI_MODULE_DESCRIPTION");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("AWZ_BXAPI_MODULE_NAME"),
    ...
    function DoUninstall()
    {
        ...
        if($step < 2) {
            $APPLICATION->IncludeAdminFile(
                Loc::getMessage('AWZ_BXAPI_INSTALL_TITLE'),
    ...
    function InstallDB()
    {
        ...
        $this->errors = false;
        if(!$this->errors && !$DB->TableExists('b_'.implode('_', explode('.',$this->MODULE_ID)).'_tokens')) {
